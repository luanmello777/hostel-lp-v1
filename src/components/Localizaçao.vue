<template>
    <div class="bg-secondary pt-sm-16">
        <div class="d-flex pt-16 pb-16 px-2 px-sm-4 px-lg-10 mt-sm-4 mt-xl-16" align="center" justify="center" id="localizaçao">
            ...
            <div class="w-100">
                <v-img src="/soul.jpg" cover height="210" class="rounded-lg d-sm-none" />
                <v-img src="/soul.jpg" cover height="400" class="rounded-lg d-none d-sm-block d-md-none" />
                <v-img src="/soul.jpg" cover height="600"
                    class="rounded-lg  d-none d-sm-none d-md-block d-xl-none" />
                <v-img src="/soul.jpg" cover height="850" class="rounded-lg w-75 d-none d-xl-block" />
            </div>
        </div>
    </div>
